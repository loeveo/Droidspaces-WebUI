...
func main() {
	...
	server, err := web.NewServer(web.Options{
		...
		UILanguageConfigured:         cfg.UILanguageConfigured,
		...
		RootfsRepositoriesConfigured: cfg.RootfsRepositoriesConfigured,
		...
		BatteryStatsRetentionDays:    cfg.BatteryStatsRetentionDays,
